...
hotel_generator_lib.py
  ...
  - decorrelate_spurious_features_in_pair(h_a, h_b, mode, strategy, util_a, util_b)
  - format_dpo_example(context_prompt, option_a_text, option_b_text, util_a, util_b, label)
"""
